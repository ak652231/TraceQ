  ...
  useEffect(() => {
    const fetchSightingReports = async () => {
      ...
      try {
        ...
        const response = await fetch(`/api/police/sighting-reports?policeId=${userId}`)
        ...
        if (data.length > 0) {
          setMapCenter([data[0].sightingLat, data[0].sightingLng])
        }
      } catch (error) {
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-8">
          ...
          <p className="font-montserrat text-gray-600 max-w-3xl">
            Welcome, {"Officer"}. View and manage sighting reports assigned to you. Verify reports, update
            statuses, and track missing person sightings.
          </p>
        </div>
                  ...
                  {filteredReports.map((report) => (
                    ...
                    >
                      ...
                      <div className="flex items-start text-sm text-gray-500 mb-2">
                        ...
                        <span className="truncate">{report.locationDetails.split(",")[0]}</span>
                      </div>
                  ...
                  <div className="p-6">
                    <div className="flex flex-wrap gap-3">
                      ...
                      <button
                        ...
                        className="px-80 py-2 rounded-md bg-gray-100 text-gray-700 hover:bg-gray-200 flex items-center"
                      >
